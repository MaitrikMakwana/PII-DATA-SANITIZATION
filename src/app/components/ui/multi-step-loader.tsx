      ...
      return (
        ...
        >
          <div>
            ...
            {index <= value && (
              <CheckFilled className={cn("text-white", value === index && "text-lime-400 opacity-100")} />
            )}
          </div>
          <span className={cn("text-white", value === index && "text-lime-400 opacity-100")}>
            {loadingState.text}
          </span>
        </motion.div>
      );
    ...
    <AnimatePresence mode="wait">
      {loading && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="w-full h-full fixed inset-0 z-[200] flex items-center justify-center"
          style={{
        ...
        >
          ...
          <div
            ...
            style={{
              background: 'radial-gradient(ellipse 80% 60% at 50% 100%, transparent 40%, rgba(10,14,26,0.6))',
              pointerEvents: 'none',
            }}
          />
        </motion.div>
